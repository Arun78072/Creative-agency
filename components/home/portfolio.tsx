    ...
    <>
      ...
      >
        <div>
          ...
          <p className="before:animate-rotate text-[20px] sm:text-[14px] sm:mt-4 text-[#464646] dark:text-[#E2E2E2] max-w-[680px] text-center mx-auto font-Quicksand relative before:content-[''] before:absolute before:-right-56 before:-top-4 before:bg-[url('/svg/purple_pattern.svg')]  before:w-[100px] before:h-[80px] before:bg-no-repeat before:-rotate-12">
            all projects that we have already done , proven can help to use more
            comfortable, then can used by client from our business
          </p>
          <div className="after:animate-wiggle1 flex gap-16 sm:flex-wrap sm:justify-center md:gap-2 items-center mt-20 sm:mt-3 relative after:bg-[url('/svg/purple_pattern.svg')] after:absolute after:content-['']  after:w-[100px] after:h-[80px] after:bg-no-repeat after:top-1/4 after:right-[61%] after:-z-10 after:rotate-45">
